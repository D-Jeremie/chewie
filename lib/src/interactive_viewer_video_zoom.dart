...
///     which includes the use of InteractiveViewerVideoZoom.
///
...
/// {@end-tool}
@immutable
class InteractiveViewerVideoZoom extends StatefulWidget {
  /// Create an InteractiveViewerVideoZoom.
  ///
  /// The [child] parameter must not be null.
  InteractiveViewerVideoZoom({
    Key? key,
  ...
  /// is often useful when a child should be bigger than the InteractiveViewerVideoZoom.
  ///
  ...
  ///
  /// At the time this is called, the [TransformationControllerZoom] will have
  /// already been updated to reflect the change caused by the interaction.
  ///
  /// {@template flutter.widgets.InteractiveViewerVideoZoom.onInteractionEnd}
  ...
  ///
  /// At the time this is called, the [TransformationControllerZoom] will not have
  /// changed due to this interaction.
  ///
  /// {@macro flutter.widgets.InteractiveViewerVideoZoom.onInteractionEnd}
  ///
  ...
  /// [TransformationControllerZoom.toScene] for how to convert these coordinates to
  ...
  /// A [TransformationControllerZoom] for the transformation performed on the
  /// child.
  ///
  ...
  ///
  /// ```dart
  /// final TransformationControllerZoom _transformationController = TransformationControllerZoom();
  ...
  /// See also:
  ///
  ///  * [ValueNotifier], the parent class of TransformationControllerZoom.
  ...
  static Vector3 getNearestPointInside(Vector3 point, Quad quad) {
    ...
    final List<Vector3> closestPoints = <Vector3>[
      InteractiveViewerVideoZoom.getNearestPointOnLine(
  ...
  @override
  InteractiveViewerVideoZoomState createState() =>
      InteractiveViewerVideoZoomState();
}

class InteractiveViewerVideoZoomState extends State<InteractiveViewerVideoZoom>
    with TickerProviderStateMixin {
  TransformationControllerZoom? _transformationController;
  ...
  void _onTransformationControllerZoomChange() {
    // A change to the TransformationControllerZoom's value is a change to the
    // state.
    setState(() {});
  }
  ...
  void initState() {
    ...
    _transformationController =
        widget.transformationController ?? TransformationControllerZoom();
    _transformationController!
        .addListener(_onTransformationControllerZoomChange);
  ...
  @override
  void didUpdateWidget(InteractiveViewerVideoZoom oldWidget) {
    ...
    if (oldWidget.transformationController == null) {
      if (widget.transformationController != null) {
        _transformationController!
            .removeListener(_onTransformationControllerZoomChange);
      ...
      if (widget.transformationController == null) {
        _transformationController!
            .removeListener(_onTransformationControllerZoomChange);
        _transformationController = TransformationControllerZoom();
        _transformationController!
            .addListener(_onTransformationControllerZoomChange);
...
/// See also:
///
///  * [InteractiveViewerVideoZoom.transformationController] for detailed documentation
///    on how to use TransformationControllerZoom with [InteractiveViewer].
class TransformationControllerZoom extends ValueNotifier<Matrix4> {
  /// Create an instance of [TransformationControllerZoom].
  ///
  /// The [value] defaults to the identity matrix, which corresponds to no
  /// transformation.
  TransformationControllerZoom([Matrix4? value])
...
Quad _getAxisAlignedBoundingBoxWithRotation(Rect rect, double rotation) {
  ...
  return InteractiveViewerVideoZoom.getAxisAlignedBoundingBox(
      boundariesRotated);
}
